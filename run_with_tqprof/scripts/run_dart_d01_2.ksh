...
ln -sf /gpfs/research/scratch/sa24m/base/output/2017042712/obs_seq.out ./obs_seq.out
...
#    ln -sf ${ENS_WRF_DIR}/${PREV_DATE}/$CMEM/wrfinput_d01_${FILE_DATE} $WORK_DIR/priors/wrfinput_d01.$CMEM
   ln -sf ${ENS_WRF_DIR}/${DATE_short}/$CMEM/wrfout_d01_2017-04-27_12:00:00 $WORK_DIR/priors/wrfinput_d01.$CMEM
#    /gpfs/research/chipilskigroup/stephen_asare/mpd/osse_out/ens_wrf/2017042700/e001/wrfout_d01_2017-04-27_12:00:00
...
cp /gpfs/home/sa24m/scratch/mpd/mpd/osse_out/real_fc/2017042700/wrfout_d01_2017-04-27_12:00:00 ./wrfinput_d01
cp /gpfs/home/sa24m/scratch/mpd/mpd/osse_out/real_fc/2017042700/wrfbdy_d01 ./wrfbdy_d01
# #fi
...
##   if [[ "${minute2}" -eq "00" ]] then
    ...
    #  ln -sf $DART_D01_DIR/$PREV_DATE/output_priorinf_sd.nc   input_priorinf_sd.nc 
     ln -sf /gpfs/home/sa24m/scratch/mpd/mpd/osse_out/dart_eakf_d01/2017042700/output_priorinf_mean.nc input_priorinf_mean.nc
     ln -sf /gpfs/home/sa24m/scratch/mpd/mpd/osse_out/dart_eakf_d01/2017042700/output_priorinf_sd.nc   input_priorinf_sd.nc
##   else
...
srun --partition=backfill2 -n 64 ${WORK_DIR}/filter
