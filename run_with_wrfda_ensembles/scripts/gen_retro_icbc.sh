...
paramfile="/gpfs/home/sa24m/Research/wrf_dart_tutorials/run_with_wrfda_ensembles/scripts/param.sh"   # set this appropriately #%%%#
...
EOF
      ...
      echo "#SBATCH -C 'intel,YEAR2015|intel,YEAR2017'" >> script.sed
